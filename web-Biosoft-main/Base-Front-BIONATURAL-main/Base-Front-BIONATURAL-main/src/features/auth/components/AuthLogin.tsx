            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input id="reg-phone" value={registerForm.phone}
                  onChange={e => setRegisterForm(p => ({ ...p, phone: e.target.value.replace(/\D/g, '').slice(0, 30) }))}
                  placeholder="+57 300 000 0000" className="pl-10 h-9 text-sm" autoComplete="off" inputMode="numeric" maxLength={30} />
              </div>
            </div>
